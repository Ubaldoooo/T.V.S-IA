    ...
    if (speechSynthesis.getVoices().length === 0) {
        ...
        if (SpeechRecognition) {
             ...
             recognition.onerror = (event) => {
                 ...
                 // addMessage(`Nexus AI (Error Voz): ${event.error}`, 'aura'); // Updated message format
             };
              ...
              recognition.onend = () => {
                 ...
                 chatInput.placeholder = "Habla o escribe a Nexus AI..."; // Updated placeholder
...
6. **NO CAMBIES EL FORMATO DEL JSON**: El formato debe ser exactamente el mostrado.
                ...
                if (!response.ok) {
                    ...
                    let errorDetail = responseBodyText; // Default to raw text
                     ...
                     hideLoader();
                     const errorMessage = `Nexus AI (Error API - ${response.status}): ${errorDetail}`; // Updated error message
